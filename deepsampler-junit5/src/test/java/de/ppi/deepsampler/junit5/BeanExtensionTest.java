...
class BeanExtensionTest {
    ...
    public static final String SAVED_SAMPLER_FILE = "samplerCanBeSavedUsingABeanExtension.json";
    public static final Path EXPECTED_SAVED_FILE_INCLUDING_ROOT_PATH = Paths.get("./src/test/tmp/de/ppi/deepsampler/junit5").resolve(SAVED_SAMPLER_FILE);
