...
/**
 * A custom SpringInterceptor that defines which classes should be intercepted, i.e. which classes can be stubbed.
 */
@Aspect
public class CustomSpringSamplerInterceptor extends SpringSamplerInterceptor {
     ...
     * for the test {@link SamplerInterceptorTest#serviceCanBeCastedFromInterfaceToConcrete()}. This test casts a
